...
echo '<link href="../karen.css" type="text/css" rel="stylesheet">';
    ...
    $zona = $_REQUEST['codigo'];
    $conexion = mysqli_connect ("localhost", "root", "rootroot")
        or die ("No se puede conectar con el servidor");
    mysqli_select_db ($conexion,"inmobiliaria")
        or die ("No se puede seleccionar la base de datos");

    $instruccion = "select * from pisos where Codigo_piso='$zona'";
...
?>
<form action="confcomp.php" method="POST">
    <a>¿Quieres comprarlo?</a><br>
    <input type='radio' name='confirmo' value='si'> SI   </input>
    <input type='radio' name='confirmo' value='no'> NO   </input><br>
    <a>Vuelva a escribir el código para confirmar su compra: <input type='text' name='codigo' placeholder="Código..."></a>
    <br><input type="Submit" value="Comprar" name="entrar"><br><br>
</form>
<a href="./compradorindex.php">Inicio</a>
</BODY>
</HTML>
